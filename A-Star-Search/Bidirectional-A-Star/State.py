...
class State(StateBase):
   ...
   #Inherited constructor
    def __init__(self, value, g_score, parent, goal,direction=True,scale=1):
        StateBase.__init__(self,value,g_score,parent,direction)
        self.n = int(math.sqrt(len(value)))
        self.h_score = self.hueristic(value,goal,scale)

    def hueristic(self,value,goal,scale=1):
    	return call_hueristic(value,goal,self.n,0,scale)
